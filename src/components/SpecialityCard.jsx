...
const SpecialityCard = ({ image, title, description }) => {
  return (
    <div className="flex bg-zinc-50 text-center text-surface/75 dark:bg-gradient-to-r from-cyan-400 to-blue-400 dark:text-black/75 lg:text-left rounded-lg shadow-md overflow-hidden hover:shadow-xl hover:shadow-slate-500">
