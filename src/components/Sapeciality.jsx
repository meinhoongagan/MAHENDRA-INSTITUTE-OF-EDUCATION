...
const Sapeciality = () => {
  ...
  <div className="flex bg-white rounded-lg shadow-md overflow-hidden  hover:shadow-xl hover:shadow-slate-500 mx-4">
  ...
  <div className="flex bg-white rounded-lg shadow-md overflow-hidden  hover:shadow-xl hover:shadow-slate-500 ml-4">
